...
text = ["¿Qué ocurre Reed? ¿Ya se ha cansado de deambular por todo el barco y va a esperara a la policía de una vez?",
	...
	"Pero hay algo que no cuadra y de eso también se perctó Zero. Les ha estado chantajeando durante meses para no destapar públicamente que cuando se conocieron ella era su profesora, acabando con la carrera de ambos.",
